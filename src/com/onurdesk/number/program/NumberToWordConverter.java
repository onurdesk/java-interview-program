...
/**
 * @author KK JavaTutorials This java program is all about How to convert an
 *         integer number to equivalent in word format
 */
public class NumberToWordConverter {
	...
	private static String convertNumberToWords(int number) {
		...
		// We should add minus before conversion if the number is less than 0 ( for
		// negative number)
		if (number < 0) {
